...
func (m *HeaderValue) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("custom_headers.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/custom_headers.HeaderValue")); err != nil {
		return 0, err
	}
