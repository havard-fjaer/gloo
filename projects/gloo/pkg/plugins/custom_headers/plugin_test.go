...
var testBrokenConfigNoRequestHeader = &custom_headers.HeaderManipulation{
	...
	ResponseHeadersToAdd:    []*custom_headers.HeaderValueOption{{Header: &custom_headers.HeaderValue{Key: "foo", Value: "bar"}, Append: &wrappers.BoolValue{Value: true}}},
	ResponseHeadersToRemove: []string{"b"},
}

var testBrokenConfigNoResponseHeader = &custom_headers.HeaderManipulation{
	...
	RequestHeadersToRemove:  []string{"a"},
	ResponseHeadersToAdd:    []*custom_headers.HeaderValueOption{{Header: nil, Append: &wrappers.BoolValue{Value: true}}},
	ResponseHeadersToRemove: []string{"b"},
}

var testHeaderManip = &custom_headers.HeaderManipulation{
	RequestHeadersToAdd: []*envoycore_sk.HeaderValueOption{{HeaderOption: &envoycore_sk.HeaderValueOption_Header{Header: &envoycore_sk.HeaderValue{Key: "foo", Value: "bar"}},
		Append: &wrappers.BoolValue{Value: true}}},
	RequestHeadersToRemove:  []string{"a"},
	ResponseHeadersToAdd:    []*custom_headers.HeaderValueOption{{Header: &custom_headers.HeaderValue{Key: "foo", Value: "bar"}, Append: &wrappers.BoolValue{Value: true}}},
...
var testHeaderManipWithSecrets = &custom_headers.HeaderManipulation{
